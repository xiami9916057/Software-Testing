...
TEST(TriangleTest, SimpleLoopCoverage){
	...
	/* 04   EXPECT_STREQ("Impossible",Triangle(?,?,?).c_str());*/
	/* 05 */EXPECT_STREQ("Not a Triangle",Triangle(20,10,10).c_str());
	/* 06   EXPECT_STREQ("Impossible",Triangle(?,?,?).c_str());*/
	/* 07   EXPECT_STREQ("Impossible",Triangle(?,?,?).c_str());*/
	/* 08   EXPECT_STREQ("Impossible",Triangle(?,?,?).c_str());*/
	...
	/* 02 */EXPECT_STREQ("Isosceles",Triangle(10,10,15).c_str());
	/* 03 */EXPECT_STREQ("Isosceles",Triangle(10,15,15).c_str());
	...
	/* 06   EXPECT_STREQ("Impossible",Triangle(?,?,?).c_str());*/
	/* 07   EXPECT_STREQ("Impossible",Triangle(?,?,?).c_str());*/
	/* 08 */EXPECT_STREQ("Equilateral",Triangle(10,10,10).c_str());
} 
