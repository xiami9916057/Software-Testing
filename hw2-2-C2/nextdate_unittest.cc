...
TEST(NextDateTest, SimpleLoopCoverage){
	...
	/* 02 */EXPECT_STREQ("2010.2.1",NextDate(1,31,2010).c_str());
	/* 03 */EXPECT_STREQ("2010.4.16",NextDate(4,15,2010).c_str());
	...
	/* 02 */EXPECT_STREQ("2010.5.1",NextDate(4,30,2010).c_str());
	/* 03 */EXPECT_STREQ("2010.3.16",NextDate(3,15,2010).c_str());
	...
	/* 04 */EXPECT_STREQ("2010.12.16",NextDate(12,15,2010).c_str());	
	/* 05 */EXPECT_STREQ("2012.2.1",NextDate(1,31,2012).c_str());
	/* 06 */EXPECT_STREQ("2010.2.1",NextDate(1,31,2010).c_str());
	/* 07 */EXPECT_STREQ("2012.1.16",NextDate(1,15,2012).c_str());
	/* 08 */EXPECT_STREQ("2010.1.16",NextDate(1,15,2010).c_str());	
	...
	/* 04 */EXPECT_STREQ("2010.2.16",NextDate(2,15,2010).c_str());	
	/* 05 */EXPECT_STREQ("2012.4.29",NextDate(4,28,2012).c_str());
	/* 06 */EXPECT_STREQ("2010.4.29",NextDate(4,28,2010).c_str());
	/* 07 */EXPECT_STREQ("2012.4.16",NextDate(4,15,2012).c_str());
	/* 08 */EXPECT_STREQ("2010.4.16",NextDate(4,15,2010).c_str());						
